...
public class D3DContent {
    ...
    public static Buffer CreateMesh(D3DDevice device) {
        ...
        var vertexShaderByteCode = ShaderBytecode.CompileFromFile("Controls\\D3D\\MiniCube.fx", "VS", "vs_4_0");
        var vertexShader = new VertexShader(device, vertexShaderByteCode);

        var pixelShaderByteCode = ShaderBytecode.CompileFromFile("Controls\\D3D\\MiniCube.fx", "PS", "ps_4_0");
