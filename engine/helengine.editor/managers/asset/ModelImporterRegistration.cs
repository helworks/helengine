namespace helengine.editor {
    /// <summary>
    /// Describes a model importer registration with supported extensions.
    /// </summary>
    public class ModelImporterRegistration : IAssetImporterRegistration {
        /// <summary>
        /// Identifier used to reference the importer in settings.
        /// </summary>
        readonly string ImporterIdValue;

        /// <summary>
        /// Importer implementation used for model assets.
        /// </summary>
        readonly IModelImporter ImporterValue;
        ...
        /// <summary>
        /// Initializes a new model importer registration.
        /// </summary>
        ...
        public ModelImporterRegistration(string importerId, IModelImporter importer, IReadOnlyList<string> extensions) {
            ...
            ImporterValue = importer;
            ExtensionsValue = NormalizeExtensions(extensions);
        }

        /// <summary>
        /// Gets the identifier used to reference the importer in settings.
        /// </summary>
        public string ImporterId => ImporterIdValue;

        /// <summary>
        /// Gets the importer implementation.
        /// </summary>
        public IModelImporter Importer => ImporterValue;
        ...
        public void Register(AssetImportManager manager) {
            ...
            manager.RegisterModelImporter(this);
        }
