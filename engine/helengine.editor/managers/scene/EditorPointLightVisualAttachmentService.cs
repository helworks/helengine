namespace helengine.editor {
    /// <summary>
    /// Attaches the hidden editor point-light visual component to scene entities that own a point light.
    /// </summary>
    public static class EditorPointLightVisualAttachmentService {
        /// <summary>
        /// Ensures one scene entity with a point light component also owns the hidden editor point-light visual child entity.
        /// </summary>
        ...
        public static bool Attach(
            ...
            EditorPointLightVisualResources visualResources) {
            if (entity == null) {
            ...
            if (visualResources == null) {
                throw new ArgumentNullException(nameof(visualResources));
            }
            ...
            EditorEntity visualEntity = new EditorEntity(entity.OwnerCore, EditorEntity.RequireInteractionServices(entity.OwnerCore)) {
                InternalEntity = true,
            ...
            visualEntity.AddComponent(new EditorPointLightVisualComponent(generatedMaterialCache, visualResources));
        ...
        /// <summary>
        /// Determines whether the entity already owns the hidden point-light visual child.
        /// </summary>
        /// <param name="entity">Entity whose direct children should be inspected.</param>
        /// <returns>True when a point-light visual child is already attached.</returns>
        static bool HasVisualChild(EditorEntity entity) {
            ...
            for (int i = 0; i < entity.Children.Count; i++) {
                ...
                if (HasComponent<EditorPointLightVisualComponent>(childEntity)) {
                    return true;
                }
            }
