namespace helengine.editor {
    ...
    public static class EditorViewportCanvasPlaneCoordinateMapper {
        ...
        /// <param name="sceneCanvasProfileState">Scene-owned canvas profile state that defines the logical target size.</param>
        ...
        public static int2 MapWorldToCanvas(float3 worldPoint, EditorSceneCanvasProfileState sceneCanvasProfileState, EditorViewportCanvasPreviewSettings settings) {
            ...
            int canvasHeight = Math.Max(1, sceneCanvasProfileState.CanvasHeight);
