namespace helengine.editor {
    /// <summary>
    /// Creates scale gizmo entities composed of shafts, box tips, and planar scale handles.
    /// </summary>
    public static class TransformScaleGizmoFactory {
        /// <summary>
        ...
        /// <summary>
        /// Width of the box tip along local X.
        /// </summary>
        public const float TipWidth = 0.18f;
        /// <summary>
        /// Height of the box tip along local Y.
        /// </summary>
        public const float TipHeight = 0.18f;
        /// <summary>
        /// Depth of the box tip along local Z.
        /// </summary>
        public const float TipDepth = 0.18f;
        /// <summary>
        /// Total axis length from origin to the far end of the box tip used for view-percentage scaling.
        /// </summary>
        public const float AxisLength = ShaftLength + TipHeight;
        /// <summary>
        /// Side length of planar scale handles.
        /// </summary>
        public const float PlaneSize = 0.25f;
        /// <summary>
        /// Offset from the origin where planar scale handles begin.
        /// </summary>
        public const float PlaneInset = 0.20f;
        /// <summary>
        /// Segment count used by generated cylinders.
        /// </summary>
        ...
        /// <summary>
        /// Creates a scale gizmo using the same material for normal and highlighted states.
        /// </summary>
        ...
        /// <summary>
        /// Creates a scale gizmo root entity and registers it in the scene.
        /// </summary>
        /// <param name="render3D">Renderer used to build runtime mesh resources.</param>
        /// <param name="sceneCamera">Scene camera used for gizmo distance scaling.</param>
        /// <param name="gizmoMaterial">Base material used by gizmo meshes.</param>
        /// <param name="gizmoHighlightMaterial">Highlight material used when a handle is hovered.</param>
        /// <returns>Created gizmo root entity.</returns>
        public static EditorEntity Create(
            ...
            if (ownerCore == null) {
                throw new InvalidOperationException("A scale gizmo requires a renderer or camera owner core.");
            }

            ModelAsset xShaftAsset = TransformGizmoMeshFactory.CreateCylinder(ShaftRadius, ShaftLength, AxisSegments);
            ModelAsset xTipAsset = TransformGizmoMeshFactory.CreateBox(TipWidth, TipHeight, TipDepth);
            ModelAsset yShaftAsset = TransformGizmoMeshFactory.CreateCylinder(ShaftRadius, ShaftLength, AxisSegments);
            ModelAsset yTipAsset = TransformGizmoMeshFactory.CreateBox(TipWidth, TipHeight, TipDepth);
            ModelAsset zShaftAsset = TransformGizmoMeshFactory.CreateCylinder(ShaftRadius, ShaftLength, AxisSegments);
            ModelAsset zTipAsset = TransformGizmoMeshFactory.CreateBox(TipWidth, TipHeight, TipDepth);
            ...
            gizmoRoot.AddComponent(new TransformScaleGizmoFollowComponent(sceneCamera, gizmoRoot, gizmoMaterial, gizmoHighlightMaterial));
            ...
            CreateAxisEntity(gizmoRoot, "Transform Scale Gizmo X", xAxisOrientation, new float3(0f, ShaftLength, 0f), xShaftModel, xTipModel, gizmoMaterial);
            CreateAxisEntity(gizmoRoot, "Transform Scale Gizmo Y", yAxisOrientation, new float3(0f, ShaftLength, 0f), yShaftModel, yTipModel, gizmoMaterial);
            CreateAxisEntity(gizmoRoot, "Transform Scale Gizmo Z", zAxisOrientation, new float3(0f, ShaftLength, 0f), zShaftModel, zTipModel, gizmoMaterial);
            CreatePlaneEntity(
                gizmoRoot,
                "Transform Scale Gizmo XY Plane",
                float4.Identity,
            ...
            CreatePlaneEntity(
                gizmoRoot,
                "Transform Scale Gizmo XZ Plane",
            ...
            CreatePlaneEntity(
                gizmoRoot,
                "Transform Scale Gizmo YZ Plane",
        ...
        /// <summary>
        /// Creates one axis entity containing a shaft and box-tip mesh.
        /// </summary>
        ...
        /// <param name="tipOffset">Axis-local offset from origin to the box tip base.</param>
        /// <param name="shaftModel">Runtime mesh used by the shaft.</param>
        /// <param name="tipModel">Runtime mesh used by the box tip.</param>
        ...
        /// <summary>
        /// Creates one plane handle entity used for planar scale.
        /// </summary>
