...
namespace helengine {
    ...
    /// </summary>
    public sealed class EditorDirectionalLightVisualResources : IDisposable {
        /// <summary>
        ...
        /// <summary>
        /// Initializes one directional-light visual resource owner for one renderer.
        /// </summary>
        public EditorDirectionalLightVisualResources(RenderManager3D renderManager3D) {
        ...
        public RuntimeModel GetRuntimeModel() {
            if (IsDisposed) {
                throw new ObjectDisposedException(nameof(EditorDirectionalLightVisualResources));
            }
        ...
        /// <summary>Releases the renderer-owned directional-light visual model.</summary>
        public void Dispose() {
            if (IsDisposed) {
                return;
            }
