namespace helengine.editor {
    ...
    /// </summary>
    public sealed class EditorAssetPickerService : IDisposable {
        /// <summary>
        /// Raised when an editor field requests an asset pick operation.
        /// </summary>
        public event Action<AssetPickerRequest> PickRequested;
        ...
        public void RequestPick(Action<AssetBrowserEntry> onPicked) {
            if (onPicked == null) {
        ...
        public void RequestPick(Action<AssetBrowserEntry> onPicked, string extensionFilter) {
            if (onPicked == null) {
                throw new ArgumentNullException(nameof(onPicked));
            }
