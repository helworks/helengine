...
public sealed class PsVitaLambertFallbackSourceTests {
    ...
    public void PsVita_runtime_model_copies_normals_for_lambert_fallback() {
        string headerPath = PsVitaFixtureRepository.ResolveSourcePath("rendering/PsVitaRuntimeModel.hpp");
        string sourcePath = PsVitaFixtureRepository.ResolveSourcePath("rendering/PsVitaRuntimeModel.cpp");
    ...
    public void PsVita_render_manager_uses_existing_lights_and_colored_vertices_for_lambert_fallback() {
        string headerPath = PsVitaFixtureRepository.ResolveSourcePath("rendering/PsVitaRenderManager3D.hpp");
