...
public sealed class CityEmptyStartupProbeSourceTests {
    ...
    public void City_empty_startup_probe_source_exposes_editor_command_and_factory() {
        string factorySourcePath = CityFixtureRepository.ResolveSourcePath("menu.tools/Ps2EmptyStartupProbeSceneFactory.cs");
        string commandSourcePath = CityFixtureRepository.ResolveSourcePath("menu.tools/RegeneratePs2EmptyStartupProbeCommand.cs");
