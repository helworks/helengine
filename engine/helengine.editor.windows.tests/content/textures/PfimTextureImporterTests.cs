...
namespace helengine.editor.windows.tests.content.textures {
    /// <summary>
    /// Verifies Pfim-backed texture imports from real encoded TGA files.
    /// </summary>
    public sealed class PfimTextureImporterTests : IDisposable {
        ...
        public void ImportTexture_WhenStreamContainsTga32_ReturnsRgbaBytes() {
            ...
            File.WriteAllBytes(sourcePath, TextureImporterFixtureData.CreateSinglePixelTga32File());
        ...
        public void ImportTexture_WhenStreamContainsTga24_ReturnsRgbaBytesWithOpaqueAlpha() {
            ...
            File.WriteAllBytes(sourcePath, TextureImporterFixtureData.CreateSinglePixelTga24File());
        ...
        public void ImportTexture_WhenStreamContainsDds_ReturnsRgbaBytes() {
            ...
            File.WriteAllBytes(sourcePath, TextureImporterFixtureData.CreateSinglePixelDdsFile());
