...
namespace helengine.editor.windows.tests.content.textures {
    /// <summary>
    /// Verifies Magick-backed texture imports from real encoded PNG files.
    /// </summary>
    public sealed class MagickTextureImporterTests : IDisposable {
        ...
        public void ImportTexture_WhenStreamContainsPng_ReturnsTextureAssetWithRgbaBytes() {
            ...
            File.WriteAllBytes(sourcePath, TextureImporterFixtureData.CreateSinglePixelPngFile());
        ...
        public void ImportTexture_WhenStreamContainsPsd_ReturnsTextureAssetWithRgbaBytes() {
            ...
            File.WriteAllBytes(sourcePath, TextureImporterFixtureData.CreateSinglePixelPsdFile());
