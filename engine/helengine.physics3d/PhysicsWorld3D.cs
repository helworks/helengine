namespace helengine {
    ...
    /// </summary>
    public class PhysicsWorld3D : ISceneBindablePhysicsRuntime, IPhysicsTriggerEventRuntime3D
...
#endif
    {
        ...
        /// <summary>
        /// Gets the total number of runtime bodies registered by the most recent scene binding, counting rigid bodies,
        /// character controllers and cooked static meshes, because every one of them is a body the world simulates.
        /// </summary>
        public int RegisteredBodyCount => BodyStatesValue.Count + ControllerStatesValue.Count + StaticMeshStatesValue.Count;
