...
namespace helengine {
    ...
    public static class CharacterControllerBodyTriggerResolver3D {
        ...
        public static void CollectOverlaps(CharacterControllerState3D controllerState, IReadOnlyList<BodyState3D> bodyStates, ISet<TriggerPairKey3D> currentTriggerPairs) {
            ...
            for (int index = 0; index < bodyStates.Count; index++) {
                ...
                currentTriggerPairs.Add(new TriggerPairKey3D(bodyState.Entity, controllerState.Entity));
            }
        }
