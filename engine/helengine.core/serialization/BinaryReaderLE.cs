...
namespace helengine {
    ...
    public class BinaryReaderLE : EngineBinaryReader {
        ...
        /// <summary>
        /// Initializes a little-endian reader that assumes native ownership of the supplied stream.
        /// </summary>
        ...
        internal BinaryReaderLE([NativeTakesOwnership] Stream stream, EngineBinaryStreamOwnership streamOwnership)
