...
persisted-data compatibility code in production source. Recovering an older scene means the file is regenerated by
the project's own scene generator, never rewritten in place.
