...
RuntimeStorageProfileId::RuntimeStorageProfileId(std::string value) : Value()
{
    ...
    {
throw ([&]() {
auto __ctor_arg_000000D8 = "Runtime storage-profile id is required.";
auto __ctor_arg_000000D9 = "value";
return new ArgumentException(__ctor_arg_000000D8, __ctor_arg_000000D9);
})();
    }
this->Value = value;
}
